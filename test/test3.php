...
<div class="container" id="table">
    <div class="left">
        <div id="d1"><a href=""><i class='bx bxs-user-account'></i> Thông tin khách hàng</a></div>      
        <div id="d2"><a href=""><i class='bx bx-cog' ></i> Chỉnh sửa thông tin</a></div>
    ...
    <div class="right">
        ...
        <br>
        <P>Địa chỉ nhận hàng : Số nhà 59 ngách 259/55 xóm Đồng Phú Diễn Băc Từ Liêm Hà Nội</P>
    </div>
