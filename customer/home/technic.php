    ...
    <li><a href="disney.php">Disney</a></li>
     ...
     document.getElementById("help").onclick = function () {
        location.href = "help.php";
            ...
            <div class="b2">
                <form id="search-box">
                    <input type="text" id="search-text" name="search" placeholder="Tìm kiếm sản phẩm thuộc Technic" required>
...
$total_count_query = mysqli_query($conn, "SELECT COUNT(*) AS total_count FROM products WHERE themes = 'technic'");
